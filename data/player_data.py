...
class Player_Data:
    ...
    def create_player(self, player):
        ...
        with open(self.file_name, "a", newline="", encoding="utf-8") as csvfile:
            fieldnames = ["id", "name", "id_number", "home_address", "phone_number", "email_address"]
    ...
    def get_all_players(self):
        ...
        with open(self.file_name, newline="" ,encoding="utf-8") as csvfile:
            ...
            for row in reader:
                player_list.append(Player(row["name"], row["id_number"],row["home_address"], row["phone_number"], row["email_address"]))
        return player_list
